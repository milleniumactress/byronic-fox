...
public class HelloCollision extends SimpleApplication
    ...
    private CharacterControl player;// first person player represented
    private Vector3f walkDirection = new Vector3f();// physic-controlled navigation
    ...
    public void simpleInitApp() {
        ...
        sceneModel = assetManager.loadModel("Models/forest/model.j3o");
        sceneModel.setLocalScale(1000f);
